...
# Stable bridge only. Device validation must never steal foreground unless an explicit foreground
# test job requests it. Candidate-specific finalizers are not hot-run from the supervisor wrapper.
