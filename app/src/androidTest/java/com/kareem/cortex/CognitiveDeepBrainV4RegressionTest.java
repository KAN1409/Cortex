...
public class CognitiveDeepBrainV4RegressionTest {
    ...
    private static void seed(SQLiteDatabase db,String requestId){
        ...
        insertSituation(db,"si_allowed",.2,now);insertSituation(db,"si_other",.1,now);
        CognitiveDeepBrainPacketBuilderV4.Packet packet=new CognitiveDeepBrainPacketBuilderV4.Packet(requestId,"What matters?","{}","share",
                Collections.singletonList("si_allowed"),Collections.<String>emptyList(),Collections.<String>emptyList(),Collections.<String>emptyList());
