...
public final class AudioAnalyzer {
    ...
    public static void analyze(Context ctx,KnowledgeItem item,Callback cb){
        try{
            ...
            GroqAudioTranscriber.transcribe(ctx,f,new GroqAudioTranscriber.Callback(){
                ...
                public void fail(Exception groqError){cb.fail(retryable("Groq failed: "+message(groqError),groqError));}
            });
    ...
    private static void finish(TranscriptResult t,Callback cb){
        try{
            ...
            r.engine=t.engine+"+local_analysis";
            r.version=t.version;
            ...
            r.audioProcessedDurationMs=t.processedDurationMs;
            r.audioCoverage=t.coverage;
            r.audioRawTranscript=t.rawTranscript;
            r.audioProviderMergedTranscript=t.providerMergedTranscript;
            r.audioRawProviderResponse=t.rawProviderResponse;
            cb.ok(r);
        }catch(Exception e){cb.fail(e);}
    }
}
