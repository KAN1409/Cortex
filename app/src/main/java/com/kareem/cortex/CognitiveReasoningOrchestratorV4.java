...
public final class CognitiveReasoningOrchestratorV4 {
    ...
    private static void schedule(Context context,String trigger,boolean force){
        if(context==null)return;Context app=context.getApplicationContext();String t=n(trigger);
        ...
        if(!CognitiveAutoReasoningSettingsV4.claimEnqueueSlot(app,claimedAt,force)){CognitiveAutoReasoningSettingsV4.markPipeline(app,"SUPPRESSED","enqueue_debounce",t);return;}
        try{
            Constraints constraints=new Constraints.Builder().setRequiredNetworkType(NetworkType.CONNECTED).build();
            Data input=new Data.Builder().putString(CognitiveReasoningWorkerV4.KEY_TRIGGER,t).build();
            ...
            CognitiveAutoReasoningSettingsV4.markPipeline(app,"QUEUED","workmanager_enqueued",t);
    ...
    static RunResult run(Context context,String trigger){
        if(context==null)return RunResult.skipped("no_context");Context app=context.getApplicationContext();String t=n(trigger);VaultDb db=null;String runId="";long started=System.currentTimeMillis();CognitiveAutoReasoningPolicyV4.Decision decision=null;
        try{
            ...
            decision=CognitiveAutoReasoningPolicyV4.evaluate(CognitivePulseProjectionV4.current(db,12),started);
