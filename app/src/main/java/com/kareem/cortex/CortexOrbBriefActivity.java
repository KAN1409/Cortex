...
public final class CortexOrbBriefActivity extends SatinBriefActivity {
    ...
    @Override View audioCard(PrimeBriefStore.Snapshot s){
        ...
        audioTitle=CortexUi.plain(this,"Voice recording",19,PRIMARY);CortexUi.medium(audioTitle);audioTitle.setMaxLines(1);titleBox.addView(audioTitle);audioSub=CortexUi.plain(this,"Voice note",11,SECONDARY);audioSub.setPadding(0,dp(5),0,0);titleBox.addView(audioSub);top.addView(statusChip("VOICE",RED),new LinearLayout.LayoutParams(-2,dp(32)));card.addView(top);
    ...
    void openCaptureSetup(){try{Intent i=new Intent(this,SatinCaptureActivity.class);i.putExtra("mode","voice");startActivity(i);}catch(Throwable ignored){}}
