...
public final class CognitiveDeepBrainPacketBuilderV4 {
    ...
    public static Packet build(Context context,VaultDb db,String question) {
        ...
        try {
            ...
            root.put("current_phone_context", phoneContext(context,db)); root.put("situations", situations(context,sql,situationIds,freshness.latestAppliedAt)); root.put("recent_memories", memories(context,sql,memoryIds)); root.put("worlds", worlds(context,sql,worldIds)); root.put("facts", facts(context,sql,factIds));
