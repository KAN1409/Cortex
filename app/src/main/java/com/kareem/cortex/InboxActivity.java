...
public final class InboxActivity extends Activity {
    ...
    private void build(){
        ...
        TextView sub=CortexUi.text(this,"Your intentional saves live here. Phone notifications arrive through Cortex Relay; only unresolved situations the Brain considers meaningful surface on Now.",12,CortexUi.MUTED);root.addView(sub,new LinearLayout.LayoutParams(-1,CortexUi.dp(this,64)));
