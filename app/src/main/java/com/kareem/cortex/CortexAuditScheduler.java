...
public final class CortexAuditScheduler {
    ...
    /**
     * Explicit non-destructive 30-minute soak. Runs the real functional/audit suite first,
     * then samples normal background behavior at roughly 5, 15 and 25 minutes and finalizes at 30.
     */
