...
public final class RawSignalStore {
    ...
    private static double fastConfidence(MasterRelevanceFilter.Decision d){if(d.disposition==MasterRelevanceFilter.Disposition.IGNORE)return 0.98;if(d.durable())return 0.82;return 0.55;}
