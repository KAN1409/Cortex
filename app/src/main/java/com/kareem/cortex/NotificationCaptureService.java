...
/** Raw-first notification capture. Android hints are evidence; Cortex meaning is downstream. */
public class NotificationCaptureService extends NotificationListenerService {
    ...
    private void ingest(StatusBarNotification sbn,String captureMode){VaultDb db=null;try{
        ...
        String hint=inferKind(n,e);JSONObject meta=new JSONObject();meta.put("capture_kind","android_notification");meta.put("capture_mode",captureMode);meta.put("package",pkg);meta.put("app_label",app);meta.put("posted_at",sbn.getPostTime());meta.put("notification_id",sbn.getId());meta.put("tag",sbn.getTag()==null?"":sbn.getTag());meta.put("ongoing",ongoing);meta.put("clearable",sbn.isClearable());meta.put("has_visible_text",!visible.isEmpty());meta.put("flags",n.flags);meta.put("priority",n.priority);meta.put("visibility",n.visibility);meta.put("number",n.number);meta.put("when",n.when);meta.put("color",n.color);meta.put("platform_hint",hint);meta.put("notification_kind",hint);
