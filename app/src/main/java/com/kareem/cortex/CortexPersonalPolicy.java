...
public final class CortexPersonalPolicy {
    ...
    public static double score(Context c,PrimeBriefStore.Item item){
        ...
        // Visual/OCR-derived proposals are evidence, not obligations. They need extra support before
        // interrupting the user. ChatGPT can later override this through a grounded positive boost.
