...
public final class DeterministicSemanticRecovery {
    public static final String VERSION = "deterministic_semantic_recovery_002";
    ...
    static Classification classify(String technical, String title, String body) {
        ...
        if (has(text, "i will", "i'll ", "we will", "we'll ", "promise", "by tomorrow", "هبعت", "هعمل", "هكلم", "هراجع", "هنعمل", "هخلص", "سوف ", "بكرة", "غدا"))
            return new Classification("commitment", "commitment", "WAITING", 72, .85, "explicit commitment detected deterministically");
