    ...
    public static void exportAndShare(Activity activity,VaultDb db){
        ...
        new Thread(()->{
            try{
                ...
                root.put("diagnostic_note","Regression tests are retained. This export adds live pipeline interpretation for ASR, Cortex Relay Local Bus, V4 Situation/Pulse and autonomous Gemini scheduling/gating/failure state.");
