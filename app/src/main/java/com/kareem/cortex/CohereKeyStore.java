...
public final class CohereKeyStore {
    private static final String PREFS="cortex_secure";
    private static final String VALUE="cohere_api_key";
    private static final String IV="cohere_api_key_iv";
    private static final String ALIAS="cortex_cohere_api_key";

    private CohereKeyStore(){}
