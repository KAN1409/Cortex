...
public final class VisualIntelligenceScheduler {
    ...
    static void continueChain(Context c){Context app=c.getApplicationContext();WorkManager.getInstance(app).enqueueUniqueWork(UNIQUE,ExistingWorkPolicy.APPEND_OR_REPLACE,one(app));}
