...
public final class CognitiveRetentionV4 {
    ...
    public static int reconcilePinnedEvidence(VaultDb db){
        if(db==null)throw new IllegalArgumentException("db required");CognitiveStoreV4.ensure(db);SQLiteDatabase sql=db.getWritableDatabase();
