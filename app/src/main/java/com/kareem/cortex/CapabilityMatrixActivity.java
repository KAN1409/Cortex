...
public final class CapabilityMatrixActivity extends Activity {
    ...
    Class<?> target(String k){
        ...
        if(any(k,"local_qwen","warm_qwen","screenshot_folder","screenshot_queue","background_visual","app_identity","components","db_integrity","db_schema","attachments","dedup","performance","stability_soak","debug_export","interaction_telemetry"))return EnvironmentActivity.class;
