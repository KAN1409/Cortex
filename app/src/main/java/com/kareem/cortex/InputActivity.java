...
public class InputActivity extends Activity {
    ...
    @Override protected void onPostResume(){super.onPostResume();StartupMaintenance.schedule(this);if(!isFinishing())build();}
    ...
    void build(){
        ...
        boolean screenEnabled=CortexScreenAccessibilityService.enabled(this),screenConnected=CortexScreenAccessibilityService.connected();String screenState=screenEnabled?(screenConnected?"READY · Screen understanding is enabled and connected.":"ENABLED · Android access is on; Cortex will reconnect automatically."):"SETUP NEEDED · Enable screen understanding once in Android Accessibility.";
