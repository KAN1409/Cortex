...
public class SettingsActivity extends Activity {
    ...
    void build(){LinearLayout root=new LinearLayout(this);root.setOrientation(LinearLayout.VERTICAL);root.setBackgroundColor(CortexUi.BG);ScrollView sv=new ScrollView(this);LinearLayout body=new LinearLayout(this);body.setOrientation(LinearLayout.VERTICAL);body.setPadding(dp(20),dp(14),dp(20),dp(26));sv.addView(body);root.addView(sv,new LinearLayout.LayoutParams(-1,0,1));
        ...
        body.addView(CortexUi.section(this,"Capture"));row(body,"Transcription","Voice transcription providers and preferences",AsrSettingsActivity.class);
        body.addView(CortexUi.section(this,"Data"));row(body,"Data & integrations","Backup, restore, privacy, calendar and contacts",FeatureHubActivity.class);
        body.addView(CortexUi.section(this,"Advanced"));row(body,"Advanced diagnostics","Models, runtime, audits, OCR and debug tools",EnvironmentActivity.class);row(body,"Review queue · test","Inspect uncertain actions, waiting items and decisions",ReviewQueueActivity.class);
        setContentView(root);CortexUi.fitSystemBars(this,root);}
    void row(LinearLayout parent,String title,String sub,Class<?> cls){LinearLayout c=new LinearLayout(this);c.setOrientation(LinearLayout.HORIZONTAL);c.setGravity(Gravity.CENTER_VERTICAL);c.setPadding(dp(2),dp(14),dp(2),dp(14));LinearLayout text=new LinearLayout(this);text.setOrientation(LinearLayout.VERTICAL);TextView t=CortexUi.plain(this,title,15,CortexUi.TEXT);CortexUi.medium(t);text.addView(t);TextView s=CortexUi.text(this,sub,11,CortexUi.MUTED);s.setPadding(0,dp(3),0,0);text.addView(s);c.addView(text,new LinearLayout.LayoutParams(0,-2,1));TextView go=CortexUi.plain(this,"›",25,CortexUi.MUTED);go.setGravity(Gravity.CENTER);c.addView(go,new LinearLayout.LayoutParams(dp(32),dp(44)));CortexUi.pressable(this,c,CortexUi.round(this,android.graphics.Color.TRANSPARENT,android.graphics.Color.TRANSPARENT,12));c.setOnClickListener(v->startActivity(new Intent(this,cls)));parent.addView(c);parent.addView(CortexUi.divider(this),new LinearLayout.LayoutParams(-1,dp(1)));}
}
