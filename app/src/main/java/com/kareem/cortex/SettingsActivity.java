...
public class SettingsActivity extends Activity {
    ...
    void build(){
        ...
        row(body,"Cortex Test Lab","Run the full embedded end-to-end test on this installed phone and send the structured report to ChatGPT",CortexEndToEndActivity.class);
