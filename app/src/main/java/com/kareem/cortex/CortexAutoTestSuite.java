...
public final class CortexAutoTestSuite {
    ...
    private static boolean deepCoverageFor(String k){return new HashSet<>(Arrays.asList("app_identity","components","permissions","db_integrity","db_schema","vault_readability","privacy_guard","grounded_ask","semantic_retrieval","smart_inbox","prompt_library","calendar_read","contacts_read","notification_capture","audio_asr","performance","calendar_write","external_writes","briefs","local_qwen","interaction_telemetry")).contains(k);}
