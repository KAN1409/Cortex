...
/** Visible progress UI for the bundled Egyptian Arabic + English ASR. */
public class WhisperProgressActivity extends Activity {
    ...
    void build(){
        ...
        amount=tv("Bundled model — no download required",14,accent);root.addView(amount,new LinearLayout.LayoutParams(-1,-2));
