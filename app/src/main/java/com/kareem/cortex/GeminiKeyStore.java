...
public final class GeminiKeyStore {
    ...
    private static final String IV="gemini_api_key_iv";
    private static final String ALIAS="cortex_gemini_api_key";
    ...
    public static void clear(Context context){context.getSharedPreferences(PREFS,Context.MODE_PRIVATE).edit().remove(VALUE).remove(IV).apply();}
